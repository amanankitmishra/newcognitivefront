    ...
    <div>
      <Grid container spacing={2}>
        <Grid item xs={8}>
          <Card>
            <CardContent>
              <Typography variant='h4'>{client.clientName.toUpperCase()}</Typography>
                  ...
                  <CardContent>
                    ...
                    <ul>
                      {enquiries.map((enquiry, index) => (
                        <li key={index}>
                          {enquiry.project.toUpperCase()} | Project Type : {enquiry.projectType} | Capacity :{' '}
                          {enquiry.capacity}
                        </li>
                      ))}
                    </ul>
                  ...
                  <CardContent>
                    ...
                    <ul>
                      {proposals.map((proposal, index) => (
                        <li key={index}>
                          {proposal.project.toUpperCase()} | Project Type : {proposal.projectType} | Capacity :{' '}
                          {proposal.capacity}
                        </li>
                      ))}
                    </ul>
