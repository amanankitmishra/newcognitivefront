// AddBudgetaryContractorsProposalForm.jsx
...
const AddBudgetaryContractorsProposalForm = ({ onSubmit, onCancel }) => {
      ...
      <Grid container spacing={2} maxWidth="sm">
        <Grid item xs={12} sx={{ pb: 2 }}>
          <Typography variant="h5">
            Add New Budgetary Contractor's Proposal
          </Typography>
        </Grid>
        <Grid item xs={6}>
...
export default AddBudgetaryContractorsProposalForm;
