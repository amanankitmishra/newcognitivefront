...
import { createProposal, fetchLiveHotTradingProposals } from 'src/utility/api'
...
const LiveHotProposals = () => {
  ...
  const getAllProposals = async () => {
    const res = await fetchLiveHotTradingProposals()
  ...
  return (
    <div>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='Live Hot Trading Proposals 🚀'></CardHeader>
            <CardContent>
