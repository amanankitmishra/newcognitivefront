...
import { createProposal, fetchLiveTradingProposals } from 'src/utility/api'
...
const LiveProposals = () => {
  ...
  const getAllProposals = async () => {
    const res = await fetchLiveTradingProposals()
  ...
  return (
    <div>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='Live Trading Proposals 🚀'></CardHeader>
            <CardContent>
