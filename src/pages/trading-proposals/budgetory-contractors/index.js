...
import { createProposal, fetchContractorTradingProposals } from 'src/utility/api'
...
const ContractorProposals = () => {
  ...
  const getAllProposals = async () => {
    const res = await fetchContractorTradingProposals()
  ...
  return (
    <div>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <CardHeader title='Contractor Trading Proposals 🚀'></CardHeader>
            <CardContent>
